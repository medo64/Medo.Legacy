...
namespace Test {
    public class TwofishTests {
        ...
        public void Twofish_KnownAnswers_ECB() {
            var tests = GetTestBlocks(Assembly.GetExecutingAssembly().GetManifestResourceStream("Test.Resources.Twofish.ECB_TBL.TXT"));
        ...
        public void Twofish_MonteCarlo_ECB_Encrypt() { //takes ages
            var tests = GetTestBlocks(Assembly.GetExecutingAssembly().GetManifestResourceStream("Test.Resources.Twofish.ECB_E_M.TXT"));
        ...
        public void Twofish_MonteCarlo_ECB_Decrypt() { //takes ages
            var tests = GetTestBlocks(Assembly.GetExecutingAssembly().GetManifestResourceStream("Test.Resources.Twofish.ECB_D_M.TXT"));
            var sw = Stopwatch.StartNew();
            foreach (var test in tests) {
        ...
        public void Twofish_MonteCarlo_CBC_Encrypt() { //takes ages
            var tests = GetTestBlocks(Assembly.GetExecutingAssembly().GetManifestResourceStream("Test.Resources.Twofish.CBC_E_M.TXT"));
            var sw = Stopwatch.StartNew();
            foreach (var test in tests) {
        ...
        public void Twofish_MonteCarlo_CBC_Decrypt() { //takes ages
            var tests = GetTestBlocks(Assembly.GetExecutingAssembly().GetManifestResourceStream("Test.Resources.Twofish.CBC_D_M.TXT"));
            var sw = Stopwatch.StartNew();
            foreach (var test in tests) {
