...
namespace Test {
    public class OneTimePasswordTests {
        ...
        public void HOTP_Validate() {
            ...
            Assert.Equal(true, o.IsCodeValid(755224));
            Assert.Equal(true, o.IsCodeValid(287082));
            Assert.Equal(true, o.IsCodeValid(359152));
            Assert.Equal(true, o.IsCodeValid(969429));
            Assert.Equal(true, o.IsCodeValid(338314));
            Assert.Equal(true, o.IsCodeValid(254676));
            Assert.Equal(true, o.IsCodeValid(287922));
            Assert.Equal(true, o.IsCodeValid(162583));
            Assert.Equal(true, o.IsCodeValid(399871));
            Assert.Equal(true, o.IsCodeValid(520489));
        }
        ...
        public void TOTP_Validate_SHA512() {
            ...
            Assert.Equal(true, o.IsCodeValid(90693936, new DateTime(1970, 01, 01, 00, 00, 59, DateTimeKind.Utc)));
            Assert.Equal(true, o.IsCodeValid(25091201, new DateTime(2005, 03, 18, 01, 58, 29, DateTimeKind.Utc)));
            Assert.Equal(true, o.IsCodeValid(99943326, new DateTime(2005, 03, 18, 01, 58, 31, DateTimeKind.Utc)));
            Assert.Equal(true, o.IsCodeValid(93441116, new DateTime(2009, 02, 13, 23, 31, 30, DateTimeKind.Utc)));
            Assert.Equal(true, o.IsCodeValid(38618901, new DateTime(2033, 05, 18, 03, 33, 20, DateTimeKind.Utc)));
            Assert.Equal(true, o.IsCodeValid(47863826, new DateTime(2603, 10, 11, 11, 33, 20, DateTimeKind.Utc)));
        }
