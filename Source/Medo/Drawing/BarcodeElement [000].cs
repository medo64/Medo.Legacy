...
//2010-06-30: New version for WPF.
...
namespace Medo.Windows.Media {
    ...
    public class BarcodeElement : UIElement {
        ...
        public BarcodeElement() {
            InitCode128();
            this.ValueEncoder = Code128ValueEncoder;
            _isInitializing = false;
        }


        private BarcodeKind _barcodeKind = BarcodeKind.Code128;
        /// <summary>
        /// Gets/sets start character.
        /// </summary>
        public BarcodeKind BarcodeKind {
            get { return this._barcodeKind; }
            set {
                if (this._barcodeKind != value) {
                    this._isInitializing = true;
                    this._barcodeKind = value;
                    switch (_barcodeKind) {
                        case BarcodeKind.Code128: {
                                this.InitCode128();
                                this.ValueEncoder = Code128ValueEncoder;
                                this.Value = this.Value;
                            } break;

                        case BarcodeKind.Codabar: {
                                this.InitCodabar();
                                this.StartCharacter = 'A';
                                this.EndCharacter = 'A';
                                this.ValueEncoder = CodabarValueEncoder;
                                this.Value = this.Value;
                            } break;
                        default:
                            throw new System.ArgumentOutOfRangeException("value", "Barcode kind is not recognized.");
                    }
        ...
        private delegate void ValueEncoderDelegate(BarcodeElement barcode);
        ...
        public string Value {
            ...
            set {
                ...
                this._value = value;
                if (this.ValueEncoder != null) { this.ValueEncoder.Invoke(this); }
                if (!this._isInitializing) { this.InvalidateVisual(); }
            }
        }
        ...
        private double _barWidth = 0.96; //0.01"
        /// <summary>
        ...
        private double _spaceWidth = 0.96; //0.01"
        /// <summary>
        ...
        private double _gapWidth = 0.96; //0.01"
        /// <summary>
        /// Gets/sets width of gaps.
        /// Not used for Code 128 and Codabar
        /// </summary>
        /// <exception cref="System.ArgumentOutOfRangeException">Width must be larger than 0.</exception>
        ...
        /// </summary>
        /// <exception cref="System.ArgumentOutOfRangeException">Width must be larger than 0.</exception>
        public void SetElementWidth(double value) {
            if (value <= 0) { throw new System.ArgumentOutOfRangeException("value", Resources.ExceptionWidthMustBeLargerThan0); }
            this._isInitializing = true;
            this._barWidth = value;
            this._gapWidth = value;
        ...
        private Color _barColor = Colors.Black;
        /// <summary>
        ...
        private Color _spaceColor = Colors.White;
        /// <summary>
        /// Gets/sets color of spaces.
        /// </summary>
        public Color SpaceColor {
            get { return this._spaceColor; }
            set {
        ...
        private double _barcodeHeight = 9.6; // 0.2"
        /// <summary>
        /// Gets/sets height of barcode.
        /// </summary>
        public double BarcodeHeight {
            get { return this._barcodeHeight; }
            set {
                if (value <= 0) { throw new System.ArgumentOutOfRangeException("value", Resources.ExceptionWidthMustBeLargerThan0); }
                this._barcodeHeight = value;
                if (!this._isInitializing) { this.InvalidateVisual(); }
            }
        }
        ...
        protected override void OnRender(DrawingContext drawingContext) {
            ...
            double currLeft = 0;
            double width = MeasureWidth();

            Brush barBrush = new SolidColorBrush(this.BarColor);
            Brush gapBrush = new SolidColorBrush(this.GapColor);
            Brush spaceBrush = new SolidColorBrush(this.SpaceColor);

            for (int i = 0; i < this.EncodedValue.Length; i++) {
                switch (i % 2) {
                    case 0: { //bar
                            int multiplier = this.EncodedValue[i];
                            drawingContext.DrawRectangle(barBrush, null, new Rect(currLeft, 0, multiplier * this.BarWidth, this.BarcodeHeight));
                    ...
                    case 1: { //gap or space
                            int multiplier = this.EncodedValue[i];
                            if (multiplier != 0) { //gap
                                drawingContext.DrawRectangle(gapBrush, null, new Rect(currLeft, 0, multiplier * this.GapWidth, this.BarcodeHeight));
                                currLeft += multiplier * this.GapWidth;
                            } else { //space
                                drawingContext.DrawRectangle(gapBrush, null, new Rect(currLeft, 0, this.SpaceWidth, this.BarcodeHeight));
            ...
            //drawingContext.DrawLine(new Pen(Brushes.Blue, 10), new Point(0, 0), new Point(1000, 1000));
        }
        ...
        private static void CodabarValueEncoder(BarcodeElement barcode) {
        ...
        private static void Code128ValueEncoder(BarcodeElement barcode) {
            List<int> ev = new List<int>();
        ...
        private static int GetCode128BestCodeSet(BarcodeElement barcode, string value, int currentCodeSetIndex) {
            int[] tmpCount = { 0, 0, 0 };
        ...
        private static int GetCode128CharPos(BarcodeElement barcode, string value, int codeTableIndex) {
